...
axiosInstance.interceptors.response.use((response)=>{
    ...
    if (error.response.status === 300 && error.response.data.msg == "User not found.") {
        localStorage.removeItem(_constants__WEBPACK_IMPORTED_MODULE_1__/* .USER_DETAILS */ .DX);
        js_cookie__WEBPACK_IMPORTED_MODULE_2__["default"].remove(_constants__WEBPACK_IMPORTED_MODULE_1__/* .COOKIE_TOKEN */ .t5);
    }
    return Promise.reject(error);
});
...
/* harmony export */   "V6": () => (/* binding */ SUPER_ADMIN_ACCESS_TYPE),
...
const SUPER_ADMIN_ACCESS_TYPE = "s_adm";
