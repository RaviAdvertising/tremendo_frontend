...
var vdom_cjs = __webpack_require__(5880);
...
function buildNativeFormattingFunc(standardDateProps, extendedSettings, context) {
    standardDateProps = tslib.__assign({
...
function mergeEventStores(store0, store1) {
    return {
        defs: tslib.__assign(tslib.__assign({
        }, store0.defs), store1.defs),
        instances: tslib.__assign(tslib.__assign({
...
var EVENT_REFINERS = tslib.__assign(tslib.__assign(tslib.__assign({
...
*/ function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
    var def = {
        ...
        extendedProps: tslib.__assign(tslib.__assign({
...
function triggerDateSelect(selection, pev, context) {
    context.emitter.trigger('select', tslib.__assign(tslib.__assign({
...
function applyMutationToEventDef(eventDef, eventConfig, mutation, context) {
    ...
    var copy = tslib.__assign(tslib.__assign(tslib.__assign({
    }, eventDef), standardProps), {
        ui: tslib.__assign(tslib.__assign({
        }, eventDef.ui), standardProps.ui)
    });
    if (mutation.extendedProps) {
        copy.extendedProps = tslib.__assign(tslib.__assign({
...
var CalendarApi1 = /** @class */ function() {
    ...
    CalendarApi.prototype.addEvent = function(eventInput, sourceInput) {
        if (eventInput instanceof EventApi1) {
        ...
        var state = this.getCurrentData();
        var eventSource;
        if (sourceInput instanceof EventSourceApi1) {
...
var RAW_EN_LOCALE = tslib.__assign(tslib.__assign({
...
function buildDateEnv$1(settings) {
    ...
    return new DateEnv1(tslib.__assign(tslib.__assign({
...
var ScrollResponder1 = /** @class */ function() {
    function ScrollResponder(execFunc, emitter, scrollTime, scrollTimeReset) {
        ...
        this.handleScrollRequest = function(request) {
            _this.queuedRequest = tslib.__assign({
            }, _this.queuedRequest || {
            }, request);
            _this.drain();
        };
...
var ViewContextType = vdom_cjs.createContext({
}); // for Components
...
function combineHooks(hooks0, hooks1) {
    return {
        ...
        eventRefiners: tslib.__assign(tslib.__assign({
        }, hooks0.eventRefiners), hooks1.eventRefiners),
        eventDefMemberAdders: hooks0.eventDefMemberAdders.concat(hooks1.eventDefMemberAdders),
        eventSourceRefiners: tslib.__assign(tslib.__assign({
        ...
        views: tslib.__assign(tslib.__assign({
        ...
        themeClasses: tslib.__assign(tslib.__assign({
        ...
        optionChangeHandlers: tslib.__assign(tslib.__assign({
        }, hooks0.optionChangeHandlers), hooks1.optionChangeHandlers),
        scrollGridImpl: hooks1.scrollGridImpl || hooks0.scrollGridImpl,
        contentTypeHandlers: tslib.__assign(tslib.__assign({
        }, hooks0.contentTypeHandlers), hooks1.contentTypeHandlers),
        listenerRefiners: tslib.__assign(tslib.__assign({
        }, hooks0.listenerRefiners), hooks1.listenerRefiners),
        optionRefiners: tslib.__assign(tslib.__assign({
        }, hooks0.optionRefiners), hooks1.optionRefiners),
        propSetHandlers: tslib.__assign(tslib.__assign({
...
function buildViewDef(viewType, hash, defaultConfigs, overrideConfigs) {
    ...
    return {
        ...
        defaults: tslib.__assign(tslib.__assign({
        }, superDef ? superDef.defaults : {
        }), defaultConfig ? defaultConfig.rawOptions : {
        }),
        overrides: tslib.__assign(tslib.__assign({
...
var RenderHook1 = /** @class */ function(_super) {
    ...
    RenderHook.prototype.render = function() {
        ...
        return vdom_cjs.createElement(MountHook1, {
            hookProps: hookProps,
...
function ContentHook(props) {
    return vdom_cjs.createElement(CustomContentRenderContext.Consumer, null, function(renderId) {
        return vdom_cjs.createElement(ContentHookInner1, tslib.__assign({
            renderId: renderId
        }, props));
    });
}
...
var MountHook1 = /** @class */ function(_super) {
    ...
    MountHook.prototype.componentDidMount = function() {
        ...
        if (callback) {
            callback(tslib.__assign(tslib.__assign({
...
function createViewHookComponent(options) {
    return function(viewProps) {
        return vdom_cjs.createElement(ViewContextType.Consumer, null, function(context) {
            return vdom_cjs.createElement(ViewRoot1, {
                viewSpec: context.viewSpec
            }, function(viewElRef, viewClassNames) {
                var hookProps = tslib.__assign(tslib.__assign({
                }, viewProps), {
                    nextDayThreshold: context.options.nextDayThreshold
                });
                return vdom_cjs.createElement(RenderHook1, {
                    hookProps: hookProps,
...
function buildViewSpec(viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
    ...
    return {
        ...
        optionOverrides: tslib.__assign(tslib.__assign({
...
function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
    ...
    if (eventSource && fetchId === eventSource.latestFetchId) {
        ...
        }, _a[sourceId] = tslib.__assign(tslib.__assign({
        }, eventSource), {
            isFetching: false,
            fetchRange: fetchRange
        }), _a));
...
function handleDateProfile(dateProfile, context) {
    context.emitter.trigger('datesSet', tslib.__assign(tslib.__assign({
...
var CalendarDataManager1 = /** @class */ function() {
    function CalendarDataManager(props) {
        ...
        var contextAndState = tslib.__assign(tslib.__assign({
    ...
    CalendarDataManager.prototype.resetOptions = function(optionOverrides, append) {
        var props = this.props;
        props.optionOverrides = append ? tslib.__assign(tslib.__assign({
    ...
    CalendarDataManager.prototype.processRawCalendarOptions = function(optionOverrides, dynamicOptionOverrides) {
        ...
        var refiners = this.currentCalendarOptionsRefiners = tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign({
    ...
    CalendarDataManager.prototype.processRawViewOptions = function(viewSpec, pluginHooks, localeDefaults, optionOverrides, dynamicOptionOverrides) {
        ...
        var refiners = tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign(tslib.__assign({
    ...
    SegHierarchy.prototype.toRects = function() {
        ...
        for(var level = 0; level < levelCnt; level += 1){
            ...
            for(var _i = 0, entries_1 = entries; _i < entries_1.length; _i++){
                ...
                rects.push(tslib.__assign(tslib.__assign({
                }, entry), {
...
var Toolbar1 = /** @class */ function(_super) {
    ...
    Toolbar.prototype.renderSection = function(key, widgetGroups) {
        var props = this.props;
        return vdom_cjs.createElement(ToolbarSection1, {
            key: key,
...
var CalendarContent1 = /** @class */ function(_super) {
    ...
    */ CalendarContent.prototype.render = function() {
        ...
        return vdom_cjs.createElement(ViewContextType.Provider, {
            value: viewContext
        }, toolbarConfig.header && vdom_cjs.createElement(Toolbar1, tslib.__assign({
            ref: this.headerRef,
            extraClassName: "fc-header-toolbar",
            model: toolbarConfig.header,
            titleId: viewLabelId
        }, toolbarProps)), vdom_cjs.createElement(ViewContainer1, {
            liquid: viewVGrow,
            height: viewHeight,
            aspectRatio: viewAspectRatio,
            labeledById: viewLabelId
        }, this.renderView(props), this.buildAppendContent()), toolbarConfig.footer && vdom_cjs.createElement(Toolbar1, tslib.__assign({
            ref: this.footerRef,
    ...
    CalendarContent.prototype.renderView = function(props) {
        ...
        return vdom_cjs.createElement(ViewComponent, tslib.__assign({
        }, viewProps));
    };
...
var DayHeader1 = /** @class */ function(_super) {
    ...
    DayHeader.prototype.render = function() {
        ...
        return vdom_cjs.createElement(NowTimer1, {
            unit: "day"
        }, function(nowDate, todayRange) {
            return vdom_cjs.createElement("tr", {
                role: "row"
            }, renderIntro && renderIntro('day'), dates.map(function(date) {
                return datesRepDistinctDays ? vdom_cjs.createElement(TableDateCell1, {
                ...
                }) : vdom_cjs.createElement(TableDowCell1, {
                    key: date.getUTCDay(),
                    dow: date.getUTCDay(),
                    dayHeaderFormat: dayHeaderFormat
                });
...
function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
    ...
    for(var subjectInstanceId in subjectInstances){
        ...
        for(var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++){
            ...
            var subjectDateSpan = tslib.__assign(tslib.__assign({
            }, dateSpanMeta), {
...
function isDateSelectionPropsValid(state, context, dateSpanMeta, filterConfig) {
    ...
    for(var _i = 0, _a = selectionConfig.allows; _i < _a.length; _i++){
        ...
        var fullDateSpan = tslib.__assign(tslib.__assign({
...
var SimpleScrollGrid1 = /** @class */ function(_super) {
    ...
    SimpleScrollGrid.prototype.renderChunkTd = function(sectionConfig, microColGroupNode, chunkConfig, isHeader) {
        ...
        }, vdom_cjs.createElement(Scroller1, {
...
var StandardEvent1 = /** @class */ function(_super) {
    ...
    StandardEvent.prototype.render = function() {
        ...
        return vdom_cjs.createElement(EventRoot1, {
            seg: seg,
            timeText: timeText,
...
var MorePopover1 = /** @class */ function(_super) {
    ...
    MorePopover.prototype.render = function() {
        ...
        return vdom_cjs.createElement(DayCellRoot1, {
            date: startDate,
            dateProfile: dateProfile,
            todayRange: todayRange,
            elRef: this.handleRootEl
        }, function(rootElRef, dayClassNames, dataAttrs) {
            return vdom_cjs.createElement(Popover1, {
                elRef: rootElRef,
                id: props.id,
                title: title,
                extraClassNames: [
            ...
            }, vdom_cjs.createElement(DayCellContent1, {
                date: startDate,
                dateProfile: dateProfile,
                todayRange: todayRange
            }, function(innerElRef, innerContent) {
...
var MoreLinkRoot1 = /** @class */ function(_super) {
    ...
    MoreLinkRoot.prototype.render = function() {
        ...
        return vdom_cjs.createElement(ViewContextType.Consumer, null, function(context) {
            ...
            return vdom_cjs.createElement(vdom_cjs.Fragment, null, Boolean(props.moreCnt) && vdom_cjs.createElement(RenderHook1, {
            ...
            }), state.isPopoverOpen && vdom_cjs.createElement(MorePopover1, {
                id: state.popoverId,
...
exports.BaseComponent = BaseComponent1;
exports.BgEvent = BgEvent;
exports.CalendarApi = CalendarApi1;
exports.CalendarContent = CalendarContent1;
exports.CalendarDataManager = CalendarDataManager1;
exports.CalendarDataProvider = CalendarDataProvider1;
exports.CalendarRoot = CalendarRoot1;
exports.ContentHook = ContentHook;
exports.CustomContentRenderContext = CustomContentRenderContext;
exports.DateComponent = DateComponent1;
exports.DateEnv = DateEnv1;
exports.DateProfileGenerator = DateProfileGenerator1;
exports.DayCellContent = DayCellContent1;
exports.DayCellRoot = DayCellRoot1;
exports.DayHeader = DayHeader1;
exports.DaySeriesModel = DaySeriesModel1;
exports.DayTableModel = DayTableModel1;
exports.DelayedRunner = DelayedRunner1;
exports.ElementDragging = ElementDragging1;
exports.ElementScrollController = ElementScrollController1;
exports.Emitter = Emitter1;
exports.EventApi = EventApi1;
exports.EventRoot = EventRoot1;
exports.EventSourceApi = EventSourceApi1;
exports.Interaction = Interaction1;
exports.MoreLinkRoot = MoreLinkRoot1;
exports.MountHook = MountHook1;
exports.NamedTimeZoneImpl = NamedTimeZoneImpl1;
exports.NowIndicatorRoot = NowIndicatorRoot;
exports.NowTimer = NowTimer1;
exports.PositionCache = PositionCache1;
exports.RefMap = RefMap1;
exports.RenderHook = RenderHook1;
exports.ScrollController = ScrollController1;
exports.ScrollResponder = ScrollResponder1;
exports.Scroller = Scroller1;
exports.SegHierarchy = SegHierarchy1;
exports.SimpleScrollGrid = SimpleScrollGrid1;
exports.Slicer = Slicer1;
exports.Splitter = Splitter1;
exports.StandardEvent = StandardEvent1;
exports.TableDateCell = TableDateCell1;
exports.TableDowCell = TableDowCell1;
exports.Theme = Theme1;
exports.ViewApi = ViewApi1;
exports.ViewContextType = ViewContextType;
exports.ViewRoot = ViewRoot1;
exports.WeekNumberRoot = WeekNumberRoot;
exports.WindowScrollController = WindowScrollController1;
...
var common = __webpack_require__(6014);
var tslib = __webpack_require__(752);
;
...
var TableBlockEvent1 = /** @class */ function(_super) {
    ...
    TableBlockEvent.prototype.render = function() {
        var props = this.props;
        return common.createElement(common.StandardEvent, tslib.__assign({
        }, props, {
            extraClassNames: [
                'fc-daygrid-event',
        ...
        return common.createElement(common.MoreLinkRoot, {
            ...
            popoverContent: function() {
                ...
                return common.createElement(common.Fragment, null, allSegs.map(function(seg) {
                    ...
                    }, hasListItemDisplay(seg) ? common.createElement(TableListItemEvent1, tslib.__assign({
                        seg: seg,
                        isDragging: false,
                        isSelected: instanceId === props.eventSelection,
                        defaultDisplayEventEnd: false
                    }, common.getSegMeta(seg, props.todayRange))) : common.createElement(TableBlockEvent1, tslib.__assign({
                        seg: seg,
                        isDragging: false,
                        isResizing: false,
                        isDateSelecting: false,
...
var TableCell1 = /** @class */ function(_super) {
    ...
    TableCell.prototype.render = function() {
        ...
        return common.createElement(common.DayCellRoot, {
            ...
            }), !isDisabled && common.createElement(TableCellTop1, {
                date: date,
                dateProfile: dateProfile,
                showDayNumber: props.showDayNumber,
            ...
            }, common.createElement(TableCellMoreLink1, {
                allDayDate: date,
...
var TableRow1 = /** @class */ function(_super) {
    ...
    TableRow.prototype.render = function() {
        ...
        return common.createElement("tr", {
            ...
            return common.createElement(TableCell1, {
                key: cell.key,
        ...
        if (framePositions) {
            for(var _i = 0, segPlacements_1 = segPlacements; _i < segPlacements_1.length; _i++){
                ...
                */ nodes.push(common.createElement("div", {
                ...
                }, common.getSegMeta(seg, todayRange))) : common.createElement(TableBlockEvent1, tslib.__assign({
                    seg: seg,
                    isDragging: isDragging,
    ...
    TableRow.prototype.updateSizing = function(isExternalSizingChange) {
        ...
        if (!props.forPrint && props.clientWidth !== null // positioning ready?
            ...
            this.setState({
                ...
                eventInstanceHeights: tslib.__assign(tslib.__assign({
    ...
    Table.prototype.render = function() {
        ...
        return common.createElement("div", {
            ...
            return common.createElement(common.Fragment, null, common.createElement("table", {
                ...
                return common.createElement(TableRow1, {
...
var DayTable1 = /** @class */ function(_super) {
    ...
    DayTable.prototype.render = function() {
        var _a = this, props = _a.props, context = _a.context;
        return common.createElement(Table1, tslib.__assign({
            ref: this.tableRef
...
var DayTableView1 = /** @class */ function(_super) {
    ...
    DayTableView.prototype.render = function() {
        ...
        var bodyContent = function(contentArg) {
            return common.createElement(DayTable1, {
                ref: _this.tableRef,
                dateProfile: props.dateProfile,
...
exports.DayGridView = DayTableView1;
exports.DayTable = DayTable1;
exports.DayTableSlicer = DayTableSlicer1;
exports.Table = Table1;
exports.TableView = TableView1;
...
*/ var HitDragging1 = /** @class */ function() {
    function HitDragging(dragging1, droppableStore) {
        var _this = this;
        // options that can be set by caller
...
*/ var DateClicking1 = /** @class */ function(_super) {
    ...
    function DateClicking(settings) {
        ...
        _this.handleDragEnd = function(ev) {
            ...
            if (!pointer.wasTouchScroll) {
                ...
                if (initialHit && finalHit && isHitsEqual(initialHit, finalHit)) {
                    var context = component.context;
                    var arg = tslib.__assign(tslib.__assign({
        ...
        var hitDragging = _this.hitDragging = new HitDragging1(_this.dragging, common.interactionSettingsToStore(settings));
...
var EventDragging1 = /** @class */ function(_super) {
    ...
    function EventDragging(settings) {
            ...
            if (_this.isDragging) {
                ...
                if (validMutation) {
                    ...
                    if (receivingContext_1 === initialContext_1) {
                        ...
                        initialContext_1.emitter.trigger('eventDrop', tslib.__assign(tslib.__assign(tslib.__assign({
                        }, eventChangeArg), transformed), {
                            el: ev.subjectEl,
                    ...
                    // dropped in different calendar
                        ...
                        initialContext_1.emitter.trigger('eventLeave', tslib.__assign(tslib.__assign({
                        }, eventRemoveArg), {
                        ...
                        receivingContext_1.emitter.trigger('drop', tslib.__assign(tslib.__assign({
                        }, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext_1)), {
                            draggedEl: ev.subjectEl,
                            jsEvent: ev.origEvent,
                            view: finalHit.context.viewApi
                        }));
                        receivingContext_1.emitter.trigger('eventReceive', tslib.__assign(tslib.__assign({
                        }, eventAddArg), {
                            draggedEl: ev.subjectEl,
                            view: finalHit.context.viewApi
                        }));
        ...
        var dragging3 = _this.dragging = new FeaturefulElementDragging1(settings.el);
        dragging3.pointer.selector = EventDragging.SELECTOR;
        dragging3.touchScrollAllowed = false;
        dragging3.autoScroller.isEnabled = options2.dragScroll;
        var hitDragging = _this.hitDragging = new HitDragging1(_this.dragging, common.interactionSettingsStore);
    ...
    function EventResizing(settings) {
        ...
        _this.handleDragEnd = function(ev) {
            ...
            if (_this.validMutation) {
                ...
                context.emitter.trigger('eventResize', tslib.__assign(tslib.__assign({
                }, eventChangeArg), {
                    el: _this.draggingSegEl,
...
var UnselectAuto1 = /** @class */ function() {
    function UnselectAuto(context1) {
        var _this = this;
        ...
        this.onDocumentPointerDown = function(pev) {
            ...
            _this.matchesEvent = !!common.elementClosest(downEl, EventDragging1.SELECTOR); // interaction started on an event?
        };
...
*/ var ExternalElementDragging1 = /** @class */ function() {
    function ExternalElementDragging(dragging4, suppliedDragMeta) {
        var _this = this;
        this.receivingContext = null;
        ...
        this.handleDragEnd = function(pev) {
            ...
            if (receivingContext && droppableEvent) {
                ...
                receivingContext.emitter.trigger('drop', tslib.__assign(tslib.__assign({
        ...
        var hitDragging = this.hitDragging = new HitDragging1(dragging4, common.interactionSettingsStore);
...
*/ var ExternalDraggable1 = /** @class */ function() {
    function ExternalDraggable(el, settings) {
        ...
        var dragging5 = this.dragging = new FeaturefulElementDragging1(el);
        ...
        new ExternalElementDragging1(dragging5, settings.eventData); // eslint-disable-line no-new
    }
...
__webpack_unused_export__ = ExternalDraggable1;
__webpack_unused_export__ = FeaturefulElementDragging1;
__webpack_unused_export__ = PointerDragging1;
__webpack_unused_export__ = ThirdPartyDraggable1;
exports.ZP = main;
...
var common = __webpack_require__(6014);
var tslib = __webpack_require__(752);
var daygrid = __webpack_require__(8884);
;
...
var TimeBodyAxis1 = /** @class */ function(_super) {
    ...
    TimeBodyAxis.prototype.render = function() {
        return this.props.slatMetas.map(function(slatMeta) {
            return common.createElement("tr", {
                key: slatMeta.key
            }, common.createElement(TimeColsAxisCell, tslib.__assign({
            }, slatMeta)));
        });
    };
    return TimeBodyAxis;
            ...
            chunks: [
                {
                    ...
                    content: function(arg) {
                        ...
                        }, arg.tableColGroupNode, common.createElement("tbody", null, common.createElement(TimeBodyAxis1, {
                            slatMetas: slatMetas
                        }))), common.createElement("div", {
...
var TimeColsSlatsBody1 = /** @class */ function(_super) {
    ...
    TimeColsSlatsBody.prototype.render = function() {
        ...
        return common.createElement("tbody", null, props.slatMetas.map(function(slatMeta, i) {
            ...
            }, props.axis && common.createElement(TimeColsAxisCell, tslib.__assign({
            }, slatMeta)), common.createElement(common.RenderHook, {
                hookProps: hookProps,
...
*/ var TimeColsSlats1 = /** @class */ function(_super) {
    ...
    TimeColsSlats.prototype.render = function() {
        ...
        }, props.tableColGroupNode /* relies on there only being a single <col> for the axis */ , common.createElement(TimeColsSlatsBody1, {
    ...
    TimeColsSlats.prototype.updateSizing = function() {
        ...
        if (props.onCoords && props.clientWidth !== null // means sizing has stabilized
            ...
            if (rootEl.offsetHeight) {
                props.onCoords(new TimeColsSlatsCoords1(new common.PositionCache(this.rootElRef.current, collectSlatEls(this.slatElRefs.currentMap, props.slatMetas), false, true), this.props.dateProfile, context.options.slotDuration));
            }
        }
    };
...
function webToRects(topLevelNodes) {
    ...
    var processNode = cacheable(function(node, levelCoord, stackDepth) {
        ...
        var rect = tslib.__assign(tslib.__assign({
        }, node), {
            levelCoord: levelCoord,
...
var TimeCol1 = /** @class */ function(_super) {
    ...
    TimeCol.prototype.render = function() {
        ...
        return common.createElement(common.DayCellRoot, {
            ...
            }, Boolean(props.eventDrag), Boolean(props.eventResize), Boolean(isSelectMirror))), common.createElement("div", {
                className: "fc-timegrid-now-indicator-container"
            }, _this.renderNowIndicator(props.nowIndicatorSegs)), common.createElement(TimeColMisc1, {
                date: props.date,
                dateProfile: props.dateProfile,
                todayRange: props.todayRange,
                extraHookProps: props.extraHookProps
    ...
    TimeCol.prototype.renderPositionedFgSegs = function(segs, segIsInvisible, isDragging, isResizing, isDateSelecting) {
        ...
        return common.createElement(common.Fragment, null, this.renderHiddenGroups(hiddenGroups, segs), segPlacements.map(function(segPlacement) {
            ...
            }, common.createElement(TimeColEvent1, tslib.__assign({
                seg: seg,
                isDragging: isDragging,
                isResizing: isResizing,
                isDateSelecting: isDateSelecting,
    ...
    TimeCol.prototype.renderHiddenGroups = function(hiddenGroups, segs) {
        ...
        return common.createElement(common.Fragment, null, hiddenGroups.map(function(hiddenGroup) {
            ...
            return common.createElement(TimeColMoreLink1, {
...
var TimeColsContent1 = /** @class */ function(_super) {
    ...
    TimeColsContent.prototype.render = function() {
        ...
        return common.createElement("div", {
            ...
            return common.createElement(TimeCol1, {
                key: cell.key,
                elRef: _this.cellElRefs.createRef(cell.key),
                dateProfile: props.dateProfile,
                date: cell.date,
...
----------------------------------------------------------------------------------------------------------------------*/ var TimeCols1 = /** @class */ function(_super) {
    ...
    TimeCols.prototype.render = function() {
        ...
        }, common.createElement(TimeColsSlats1, {
            axis: props.axis,
            dateProfile: props.dateProfile,
            slatMetas: props.slatMetas,
            clientWidth: props.clientWidth,
        ...
        }), common.createElement(TimeColsContent1, {
            cells: props.cells,
            axis: props.axis,
            dateProfile: props.dateProfile,
...
var DayTimeCols1 = /** @class */ function(_super) {
    ...
    DayTimeCols.prototype.render = function() {
        ...
        return common.createElement(common.NowTimer, {
            ...
            return common.createElement(TimeCols1, tslib.__assign({
...
var DayTimeColsView1 = /** @class */ function(_super) {
    ...
    DayTimeColsView.prototype.render = function() {
        ...
        var allDayContent = options.allDaySlot !== false && function(contentArg) {
            return common.createElement(daygrid.DayTable, tslib.__assign({
            }, splitProps.allDay, {
                dateProfile: dateProfile,
                dayTableModel: dayTableModel,
                nextDayThreshold: options.nextDayThreshold,
        ...
        var timeGridContent = function(contentArg) {
            return common.createElement(DayTimeCols1, tslib.__assign({
            }, splitProps.timed, {
                dayTableModel: dayTableModel,
                dateProfile: dateProfile,
...
__webpack_unused_export__ = DayTimeCols1;
__webpack_unused_export__ = DayTimeColsSlicer1;
__webpack_unused_export__ = DayTimeColsView1;
__webpack_unused_export__ = TimeCols1;
__webpack_unused_export__ = TimeColsSlatsCoords1;
__webpack_unused_export__ = TimeColsView1;
